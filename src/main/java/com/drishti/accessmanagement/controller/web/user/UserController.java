...
import static com.drishti.accessmanagement.controller.ControllerConstants.VIEW_INACTIVE_USER;
...
public class UserController {
  ...
  public ModelAndView listInActiveUsers() {
    ModelAndView modelAndView = new ModelAndView(VIEW_INACTIVE_USER);
